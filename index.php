...
<html lang="en">
    ...
    <body>
        ...
        <script src="./assets/js/fha_calculator.js?v=4"></script>
        <script src="./assets/js/conv_calculator.js?v=4"></script>
        <script src="./assets/js/va_calculator.js?v=4"></script>
        <script src="./assets/js/usda_calculator.js?v=4"></script>
